package io.github.hsn.jnastool.torrent.bencoding;


import cn.hutool.core.io.IoUtil;
import io.github.hsn.jnastool.torrent.bencoding.types.*;
...
public class Reader
{
    ...
    {
        dataBlob = IoUtil.readBytes(new FileInputStream(file));
    }

    public Reader(InputStream input) {
        dataBlob = IoUtil.readBytes(input);
    }
