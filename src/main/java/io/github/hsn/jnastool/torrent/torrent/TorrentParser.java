...
import io.github.hsn.jnastool.torrent.bencoding.types.BByteString;
import io.github.hsn.jnastool.torrent.bencoding.types.BDictionary;
import io.github.hsn.jnastool.torrent.bencoding.types.BInt;
import io.github.hsn.jnastool.torrent.bencoding.types.BList;
import io.github.hsn.jnastool.torrent.bencoding.types.IBencodable;
...
public class TorrentParser
{
    ...
    private static Torrent parseTorrent(Object o) throws ParseException
    {
        if (o instanceof BDictionary torrentDictionary)
        {
            ...
            t.setInfoHash(Utils.SHAsum(infoDictionary.encode()));
            ...
            // Determine if torrent is a single file torrent.
